...
bool J9::Options::_collectRegionMemoryLog = false;
char *J9::Options::_compilationRegionMemoryLogFileName = "alloctrace.log";
uint64_t J9::Options::_minMemoryUsageCollectRegionMemoryLog = 16384;
uint32_t J9::Options::_minOptLevelCollectRegionMemoryLog = 0;
...
TR::OptionTable OMR::Options::_feOptions[] = {
   ...
   {"collectRegionMemoryLog",               " \tcollect region log in compilations",
        TR::Options::setStaticBool, (intptr_t)&TR::Options::_collectRegionMemoryLog, 1, "F%d", NOT_IN_SUBSET},
   ...
   {"compilationRegionMemoryLogFileName=",              "L<filename>\twrite region logs to filename_compilation_seq_num",
        TR::Options::setStaticString,  (intptr_t)(&TR::Options::_compilationRegionMemoryLogFileName), 0, "P%s", NOT_IN_SUBSET},
   ...
   {"minMemoryCollectRegionMemoryLog=", "D<nnn>\tsmallest memory usage to enable collection of region log of this compilation",
      TR::Options::setStaticNumeric, (intptr_t)&TR::Options::_minMemoryUsageCollectRegionMemoryLog, 16384, "F%d", NOT_IN_SUBSET},
   {"minOptLevelCollectRegionMemoryLog=", "D<nnn>\tsmallest level of optimization to enable collection of region log of this compilation",
      TR::Options::setStaticNumeric, (intptr_t)&TR::Options::_minOptLevelCollectRegionMemoryLog, 0, "F%d", NOT_IN_SUBSET},
