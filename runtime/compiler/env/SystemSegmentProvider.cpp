...
TR::Monitor *J9::SystemSegmentProvider::_regionMemoryLogListMonitor = NULL;
...
J9::SystemSegmentProvider::SystemSegmentProvider(size_t defaultSegmentSize, size_t systemSegmentSize, size_t allocationLimit, J9::J9SegmentProvider &segmentAllocator, TR::RawAllocator rawAllocator) :
   ...
   _regionMemoryLogListHead(NULL),
   _regionMemoryLogListTail(NULL),
...
J9::SystemSegmentProvider::~SystemSegmentProvider() throw()
   ...
   if (_recordRegions && _regionBytesAllocated > TR::Options::_minMemoryUsageCollectRegionMemoryLog)
      {
      ...
      _compilation.regionMemoryLogList = _regionMemoryLogListHead;
...
void
J9::SystemSegmentProvider::segmentProviderRegionMemoryLogListInsert(RegionMemoryLog *regionMemoryLog) 
   {
   if (!_regionMemoryLogListMonitor)
      {
      createRegionMemoryLogListMonitor();
      }
   OMR::CriticalSection criticalSection(_regionMemoryLogListMonitor);
   RegionMemoryLog::regionMemoryLogListInsert(&_regionMemoryLogListHead, &_regionMemoryLogListTail, regionMemoryLog);
   }
   
void 
J9::SystemSegmentProvider::segmentProviderRegionMemoryLogListRemove(RegionMemoryLog *regionMemoryLog) 
   {
   if (!_regionMemoryLogListMonitor)
      {
      createRegionMemoryLogListMonitor();
   ...
   OMR::CriticalSection criticalSection(_regionMemoryLogListMonitor);
   RegionMemoryLog::regionMemoryLogListRemove(&_regionMemoryLogListHead, &_regionMemoryLogListTail, regionMemoryLog);
   }

void 
J9::SystemSegmentProvider::createRegionMemoryLogListMonitor() 
   {
   _regionMemoryLogListMonitor = TR::Monitor::create("RegionMemoryLogCriticalSectionMonitor");
   }
